...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      require('tokyonight').setup {
        ...
        sidebars = { 'qf', 'vista_kind', 'terminal', 'packer', 'term', 'bash', 'Terminal' },
      }
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'cpp', 'python', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'latex' },
...
-- Command, run black on current file python file with :Black
vim.cmd [[command! Black :!black %]]

-- Copy the name of current buffer to clipboard
--
vim.cmd [[command! Cb let @+=expand('%:p')]]
